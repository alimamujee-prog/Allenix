...
export const alt = 'Ali Mamujee — Founder of Allenix'
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20, maxWidth: 880 }}>
            ...
            <div style={{
              ...
              <span>Ali</span>
              <span style={{ fontStyle: 'italic', color: '#00c8b4' }}>Mamujee.</span>
            </div>
            <div style={{ fontSize: 18, color: '#5a6b7e', fontFamily: 'Georgia, serif', letterSpacing: 0.3, display: 'flex', maxWidth: 640 }}>
              Founder, Allenix. Eleven years in B2B fintech. 9-figure acquisition. Building the AI operating system for Gulf South operators.
            </div>
          </div>
